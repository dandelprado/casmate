def inject_css():
    return """
    <style>
      .chat-row { display:flex; margin:8px 0; width:100%; }
      .left { justify-content:flex-start; }
      .right { justify-content:flex-end; }
      .bubble { max-width:80%; padding:10px 14px; border-radius:14px; word-wrap:break-word; line-height:1.4; box-shadow:0 1px 2px rgba(0,0,0,0.06); }
      .casmate { background:#e0f7fa; color:#004d40; }
      .student { background:#c8e6c9; color:#1b5e20; }
